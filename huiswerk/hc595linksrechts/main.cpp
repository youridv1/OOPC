...
int main( void ){
  ...
  auto invert0 = pin_out_invert( led0 );
  auto invert1 = pin_out_invert( led1 );
  auto invert2 = pin_out_invert( led2 );
  auto invert3 = pin_out_invert( hc595.p1 );
  auto invert4 = pin_out_invert( hc595.p2 );
  auto invert5 = pin_out_invert( hc595.p3 );
  auto links = hwlib::all( invert0, invert1, invert2 );
  auto rechts = hwlib::all( invert3, invert4, invert5 );
